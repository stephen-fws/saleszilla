...
def get_potentials(
    ...
    categories: str | None = Query(default=None, description="Comma-separated category flags — Diamond, Platinum"),
    ...
    categories_list = [s.strip() for s in categories.split(",") if s.strip()] if categories else None
